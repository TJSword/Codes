  ...
  <section class="testimonials-one">
    <div class="container">
      <div class="block-title text-center">
        <h2 class="block-title__title">我们的 <span>客户</span> 怎么说 <br> 关于我们</h2><!-- /.block-title__title -->
      </div><!-- /.block-title -->
          ...
          <div class="item">
            <div class="testimonials-one__single">
              <div class="testimonials-one__inner">
                <p>2020年中国房地产行业面临前所未有的行业结构调整和市场挑战 <br> 现金流和高周转成为企业发展生存的经营保障方针 <br> 高周转作为房地产企业最重要的金融工具</p>
                <h3>一叶知秋</h3>
                <span>客研社</span>
