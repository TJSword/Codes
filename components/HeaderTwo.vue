      ...
      <div class="container clearfix">
        ...
        <div class="logo-box clearfix">
          <a class="navbar-brand" href="/">
            <img src="/assets/images/resources/logo-light.png" class="main-logo" width="130" alt="Awesome Image" />
          </a>
        ...
        <div class="right-side-box">
          <a class="thm-btn header__cta-btn" href="http://qingdao.keyanshe.ltd/" target="_blank"><span>客研云</span></a>
        </div><!-- /.right-side-box -->
      </div>
      <!-- /.container -->
    </nav>
