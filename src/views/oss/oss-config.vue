  ...
  computed: {
    dataRule() {
      return {
        ...
        fastdfsDomain: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }],
        localDomain: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }],
        localPath: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }],
        minioEndPoint: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }],
        minioAccessKey: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }],
        minioSecretKey: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }],
        minioBucketName: [{ required: true, message: this.$t("validate.required"), trigger: "blur" }]
      };
    }
  },
  watch: {
  ...
  methods: {
    ...
    dataFormSubmitHandle() {
      this.$refs["dataFormRef"].validate((valid: boolean) => {
        ...
        baseService.post("/oss/file", this.dataForm).then((res) => {
          if (res.code !== 0) {
            return this.$message.error(res.msg);
          }
          this.$message({
