...
export default {
    ...
    methods:{
        initmap(){
        //pk.eyJ1IjoiMTU5MDk4Mzk1NjQiLCJhIjoiY2tpZmt0MThrMGtwcTJ5bngxN2xqNnYzeCJ9.erBGt3UuT5gNjeD-d_p_VA
            mapboxgl.accessToken = 'pk.eyJ1Ijoibm9jb25yaWFuZGVyIiwiYSI6ImNrbXliMnRsejAyYWYyd28wc3RxYzN3ZjEifQ.9iGOZBik4yAVuNKMgrPPsA'; 
            this.map = new mapboxgl.Map({
            container: this.id, // container id 绑定的组件的id
            style: 'mapbox://styles/noconriander/ckjxqgg190k8q17qib182syt7', //地图样式，可以使用官网预定义的样式,也可以自定义
            // center: [102.509915,25.008331], // 初始坐标系
            center:["120.15681158771386", "36.02184962149909"],
