...
Page({
  ...
  data: {
    ...
    chooseAniBox: [false, true, true, true, true, true, true, true,true,true],
    optionsBit:1
  },
  ...
  getInfo(id){
    request('/fee/info/' + id,'get',{}).then(res=>{
      console.dir(res.searchRst)
      this.setData({
        info:res.searchRst,
        startDate:res.searchRst.startDate,
        endDate:res.searchRst.endDate,
        placeName:res.searchRst.address,
        people:res.searchRst.joiner,
        trafficMoney:res.searchRst.trafficFee,
        repastMoney:res.searchRst.repastFee,
        stayMoney:res.searchRst.acdFee,
        elseMoney:res.searchRst.otherFee,
        remark_content:res.searchRst.remark,
        id:res.searchRst.id
      })
